public class MediumDifficulty : Difficulty //MediumDifficulty is a type of Difficulty (Inheritence). This makes it so that it, for example, has a DifficultyName, modified health value, a modified damage value and a modified critical damage value for the enemy.
{
    ...
    //This is a constructor. This one sets the value for the variable 'DifficultyName' to the string 'Medium'.
    public MediumDifficulty()
    {
        DifficultyName = "Medium";
    }

    //The method 'ModifyEnemyHealth' has the integer paramater 'oldHealthValue', and the value 100 is assigned to it. This is then returned.
    ...
    //The method 'ModifyDamage' has the integer paramater 'oldEnemyDamageValue', and a Generator randomizing a value between 4-8 is assigned to it. This is then returned.
    ...
    //The method 'ModifyCriticalDamage' has the integer paramater 'oldEnemyCriticalDamageValue', and a Generator randomizing a value between 5-9 is assigned to it. This is then returned.
